...
public class Adaptador_MisFavoritos extends ArrayAdapter<Entity_Personaje> {

    private List<Entity_Personaje> listaPersonajes;
    private Context contexto;
    private int resourceLayout;

    public Adaptador_MisFavoritos(@NonNull Context context, int resource, List<Entity_Personaje> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Entity_Personaje per = listaPersonajes.get(position);

        ImageView img_imagenPersonaje = view.findViewById(R.id.imagen_personaje);
        Picasso.get().load(per.getUrl_imagen()).into(img_imagenPersonaje);
        ...
        txt_id.setText(per.getId_personaje());
